        ...
        <div>
            ...
            <form className='' onSubmit={hanldeSubmit}>
                ...
                <div className='flex justify-start items-center py-4'>
                    ...
                    <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-[40%] md:w-[150px]  sm:w-auto px-2 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        {loginBtn ?
