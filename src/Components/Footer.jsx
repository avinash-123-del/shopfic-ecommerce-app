            ...
            <div className="mx-auto  overflow-x-hidden p-4 px-10 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className='flex items-center font-lilita justify-start md:mb-8 mb-4'>
                        <Link to='/shopfic/home'><h1 className='text-[30px] font-bold text-stone-50'>Shopfic </h1></Link>
                        <span><LiaOpencart color='green' size={50} /></span>
                    </div>

                    <div className="grid gap-8 sm:gap-6 grid-cols-3">
                        <div>
                            <h2 className="md:mb-6 mb-3  font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
                        ...
                        <div>
                            <h2 className="md:mb-6 mb-3  font-semibold text-gray-900 uppercase dark:text-white">Follow us</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="md:mb-4 mb-2">
                                    Github
                                </li>
                        ...
                        <div>
                            <h2 className="md:mb-6 mb-3  font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="md:mb-4 mb-2">
                                    Privacy Policy
                                </li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className=" text-gray-500 sm:text-center dark:text-gray-400">© 2023 shopfic. All Rights Reserved.
                    </span>
