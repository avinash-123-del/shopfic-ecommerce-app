    ...
    return (
        <div className='shadow-lg py-3 px-6 md:px-[50px] flex justify-between items-center w-screen '>
            ...
            <div className='relative sm:hidden'>
                ...
                <ul className='sm:hidden flex justify-between items-center gap-6'>
                    <li><Link to='/home'><AiOutlineHome size={20} color='green' /></Link></li>
                    <li><Link to='/cart'><AiOutlineShoppingCart size={20} color='green' /></Link></li>
